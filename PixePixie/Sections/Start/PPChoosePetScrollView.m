...
-(void)setSCrollWith:(NSDictionary *)petsDict
{
    ...
    for (int i = 0; i < petsCount; i++) {
        UIImageView *petsImageView=[[UIImageView alloc] initWithFrame:CGRectMake(i * self.frame.size.width,
                                                                                 0.0f,
                                                                                 320.0f,
        ...
        UILabel *labelPetType = [[UILabel alloc] initWithFrame:CGRectMake(petsNameBtn.frame.origin.x,
                                                                          petsNameBtn.frame.origin.y+50,
                                                                          100, 100)];
