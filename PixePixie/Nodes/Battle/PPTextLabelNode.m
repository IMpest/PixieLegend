...
@implementation PPTextLabelNode
...
{
    PPTextLabelNode *node = [[PPTextLabelNode alloc] initWithFontNamed:fontName];
...
-(PPMultiLineLabelImage *)imageFromText:(NSString *)text
{
    ...
    PPMultiLineLabelFont *font = [PPMultiLineLabelFont fontWithName:self.fontName size:self.fontSize];
    
    if (!font) {
        font = [PPMultiLineLabelFont fontWithName:@"Helvetica" size:self.fontSize];
        NSLog(@"The font you specified was unavailable. Defaulted to Helvetica.");
        //		NSLog(@"The font you specified was unavailable. Defaulted to Helvetica. Here is a list of available fonts: %@", [PPMultiLineLabelFont familyNames]); //only available for debugging on iOS
        //		NSLog(@"Here is a list of variations to %@: %@", _fontName, [PPMultiLineLabelFont familyNames]);
    }
    ...
    PPMultiLineLabelImage *image = UIGraphicsGetImageFromCurrentImageContext();
    
    //Close the context
    UIGraphicsEndImageContext();
#else
    
    PPMultiLineLabelImage *image = [[PPMultiLineLabelImage alloc] initWithSize:textRect.size];
    /*
