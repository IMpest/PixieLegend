...
//                case 0:
//                {
//                    monsterTeamButton = [PPSpriteButton buttonWithTexture:[SKTexture textureWithImageNamed:@"skill_plant.png"]
//                                                                  andSize:CGSizeMake(40.0f,40.0f)];
//                }
//                    break;
//                case 1:
//                {
...
//            [monsterTeamButton addTarget:self selector:@selector(monsterTeamButtonClick:)
//                              withObject:monsterTeamButton.name forControlEvent:PPButtonControlEventTouchUpInside];
...
//    [monsterBoxAddButton addTarget:self selector:@selector(monsterBoxAddClick:)
//                        withObject:monsterBoxAddButton.name forControlEvent:PPButtonControlEventTouchUpInside];
